...
public class OtesSCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otessc);
        getSupportActionBar().setTitle("Listado OTES");
        int colorBanner= Color.parseColor("#1754EC");
        setActionBarColor(colorBanner);
        otData = new OTData(OtesSCActivity.this);
        logosData = new LogosOtData(OtesSCActivity.this);
        rv_otesoperarioslist = findViewById(R.id.rv_otesoperarioslist);
        rv_otesoperarioslist.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        otesRecyclerAdapter=new OtesSCAdapter(OtesSCActivity.this,solCotizacionList);
        ...
        otesRecyclerAdapter.setOnClickListener(new OtesSCAdapter.OnClickListener() {
            ...
            public void onCotizacion(View view, int position) throws Exception {
                ...
                File pdfFile = new File(OtesSCActivity.this.getCacheDir(), nomDoc);
                logosData.open();
                ...
                if (logoItem.getPdfcotizacion() != null) {
                    ...
                    try {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            Uri uri = FileProvider.getUriForFile(OtesSCActivity.this, "com.main.app_firmas_segucor",
                    ...
                    Toast.makeText(OtesSCActivity.this, "La OT no tiene una cotización relacionada", Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.btn_salir_sol_cot:
                ...
                SharedPreferences pre_operario = getSharedPreferences("datos_operador", MODE_PRIVATE);
